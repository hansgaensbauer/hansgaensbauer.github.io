...
var HanziLookup=HanziLookup||{};HanziLookup.DrawingBoard=function(e,t){"use strict";function n(){h.clearRect(0,0,h.canvas.width,h.canvas.height),h.setLineDash([5,5]),h.lineWidth=1,h.strokeStyle="black",h.beginPath(),h.moveTo(0,0),h.lineTo(h.canvas.width,0),h.lineTo(h.canvas.width,h.canvas.height),h.lineTo(0,h.canvas.height),h.lineTo(0,0),h.stroke(),h.beginPath(),h.moveTo(0,0),h.lineTo(h.canvas.width,h.canvas.height),h.stroke(),h.beginPath(),h.moveTo(h.canvas.width,0),h.lineTo(0,h.canvas.height),h.stroke(),h.beginPath(),h.moveTo(h.canvas.width/2,0),h.lineTo(h.canvas.width/2,h.canvas.height),h.stroke(),h.beginPath(),h.moveTo(0,h.canvas.height/2),h.lineTo(h.canvas.width,h.canvas.height/2),h.stroke()}

function o(e,t){u=!0,T=[],f=[e,t],T.push(f),h.strokeStyle="black",h.setLineDash([]),h.lineWidth=c,h.beginPath(),h.moveTo(e,t),l=new Date}
function i(e,t){if(!((new Date).getTime()-l<50)){l=new Date;var n=[e,t];n[0]==f[0]&&n[1]==f[1]||(T.push(n),f=n,h.lineTo(e,t),h.stroke())}}
function a(e,t){u=!1,e!=-1&&(h.lineTo(e,t),h.stroke(),T.push([e,t]),d.push(T),T=[],g&&g())}
function s(){for(var e in d){h.strokeStyle="black",h.setLineDash([]),h.lineWidth=c,h.beginPath(),h.moveTo(d[e][0][0],d[e][0][1]);for(var t=d[e].length,n=0;n<t-1;n++)h.lineTo(d[e][n][0],d[e][n][1]),h.stroke();h.lineTo(d[e][t-1][0],d[e][t-1][1]),h.stroke()}if(m){if(S&&(h.strokeStyle="blue",h.setLineDash([1,1]),h.lineWidth=.5,h.beginPath(),h.moveTo(m.left,m.top),h.lineTo(m.right,m.top),h.stroke(),h.lineTo(m.right,m.bottom),h.stroke(),h.lineTo(m.left,m.bottom),h.stroke(),h.lineTo(m.left,m.top),h.stroke()),b)for(var o=0;o!=m.xStrokes.length;++o){var i=m.xStrokes[o];h.strokeStyle="red",h.setLineDash([]),h.lineWidth=3,h.beginPath(),h.moveTo(i[0][0],i[0][1]),h.arc(i[0][0],i[0][1],3,0,2*Math.PI,!0),h.fillStyle="red",h.fill();for(var a=1;a<i.length;++a)h.lineTo(i[a][0],i[a][1]),h.stroke(),h.beginPath(),h.arc(i[a][0],i[a][1],3,0,2*Math.PI,!0),h.fillStyle="red",h.fill()}if(y&&m.yStrokes)for(var o=0;o!=m.yStrokes.length;++o){var s=m.yStrokes[o];h.strokeStyle="#e6cee6",h.setLineDash([]),h.lineWidth=c,h.beginPath(),h.moveTo(s[0][0],s[0][1]);for(var a=1;a<s.length;++a)h.lineTo(s[a][0],s[a][1]),h.stroke()}if(m.zStrokes)for(var o=0;o!=m.zStrokes.length;++o){var i=m.zStrokes[o];h.strokeStyle="green",h.setLineDash([]),h.lineWidth=1,h.beginPath(),h.moveTo(i[0][0],i[0][1]),h.arc(i[0][0],i[0][1],3,0,2*Math.PI,!0),h.fillStyle="green",h.fill();for(var a=1;a<i.length;++a)h.lineTo(i[a][0],i[a][1]),h.stroke(),h.beginPath(),h.arc(i[a][0],i[a][1],3,0,2*Math.PI,!0),h.fillStyle="green",h.fill()}}}

var r,h,l,f,v=e,g=t,c=3,u=!1,k=-1,p=-1,d=[],T=null,m=null,b=!1,S=!1,y=!1;return r=$('<canvas class="stroke-input-canvas"></canvas>'),

v.append(r),
r[0].width = r[0].height = window.innerHeight/1.7,
r[0].style.display = "block",
r[0].style.margin = "auto",
h=r[0].getContext("2d"),r.mousemove(function(e){if(u){var t=e.pageX-$(this).offset().left,n=e.pageY-$(this).offset().top;i(t,n)}}),r.mousedown(function(e){var t=e.pageX-$(this).offset().left,n=e.pageY-$(this).offset().top;o(t,n)}).mouseup(function(e){var t=e.pageX-$(this).offset().left,n=e.pageY-$(this).offset().top;a(t,n)}),r.bind("touchmove",function(e){if(u){e.preventDefault();var t=e.originalEvent.touches[0].pageX-$(this).offset().left;k=t;var n=e.originalEvent.touches[0].pageY-$(this).offset().top;p=n,i(t,n)}}),r.bind("touchstart",function(e){e.preventDefault(),document.activeElement.blur();var t=e.originalEvent.touches[0].pageX-$(this).offset().left,n=e.originalEvent.touches[0].pageY-$(this).offset().top;o(t,n)}).bind("touchend",function(e){e.preventDefault(),document.activeElement.blur(),a(k,p),k=p=-1}),n(),

{clearCanvas:function(){d.length=0},undoStroke:function(){0!=d.length&&(d.length=d.length-1)},cloneStrokes:function(){for(var e=[],t=0;t!=d.length;++t){for(var n=[],o=0;o!=d[t].length;++o)n.push([d[t][o][0],d[t][o][1]]);e.push(n)}return e},redraw:function(){n(),s()},enrich:function(e,t,o,i){m=e,S=o,b=t,y=i,n(),s()}}
};
